		...
		'<div id="ucfhb-right">',
			'<div id="ucfhb-signon">',
				'<a id="ucfhb-signon-logo" href="#">',
					'UCF Sign In <span id="ucfhb-sign-in-toggle" class="ucfhb-arrow-right"></span>',
				'</a>',
				'<div id="ucfhb-services">',
					'<div>',
						'<a id="ucfhb-myucf" class="ucfhb-service" href="https://my.ucf.edu/psp/IHPROD/EMPLOYEE/EMPL/?cmd=login">my<span>UCF</span></a>',
