...
(function () {
  ...
  var ucfhbFullWidthStylesheet = window.location.protocol + "//" + UCFHB_ROOT_URL + "/bar/css/full-width.css?" + UCFHB_VERSION; // Check if data-bootstrap-override has been passed to the
  ...
  function ucfhbCreateBar() {
    ...
    if (useFullWidth === true) {
      var fullWidthStylesheet = document.createElement('link');
