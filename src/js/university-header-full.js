(function () {
  ...
  var ucfhbAssignTrackingListener = function ucfhbAssignTrackingListener(elem, eventType, link, action, label) {
    ...
    action = action || null;
    label = label || null; // Cross-browser addEventListener check.
  ...
  var ucfhbTrackingActionLogoClick = 'ucf-logo',
      // When a UCF Login button is clicked
  ucfhbTrackingActionSearch = 'search',
  ...
  var ucfhbCreateBar = function ucfhbCreateBar(callback) {
  ...
  var ucfhbInitialize = function ucfhbInitialize() {
    /* Define listeners */
    var ucfhbEventListener = function ucfhbEventListener() {
